...
public class BlogPost {
	...
	public BlogPost(String title, String author, String link, String blogEntry, Long id) {
		this.title = title; 
	    this.author = author;
	    this.link = link;
	    this.blogEntry = blogEntry;
	...
	public String toString() {
		return "BlogPost [id=" + id + ", title=" + title + ", author=" + author + ", link=" + link + ", blogEntry=" + blogEntry + "]";
	}
